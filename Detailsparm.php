...
<body>
    ...
    <div class="movie-detail">
        <div class="poster">
            <img src="photo/sparm.jpg" alt="โปสเตอร์หนัง">
        </div>
        <div class="info">
            ...
            <div class="director">
                <h3>ผู้กำกับ</h3>
                <div class="person">
                    <img src="photo/sparmDt1.jpg" alt="ผู้กำกับ">
                    <div class="name">Tommy Wirkola</div>
                    
                </div>
                <div class="person">
                    <img src="photo/sparmDt2.jpg" alt="ผู้กำกับ">
                    <div class="name">Rasmus A. Sivertsen</div>
            </div>
